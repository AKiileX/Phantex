        ...
        try:
            ...
            if resp.status_code == 200:
                ...
                if "lm studio" in server_header or "lm-studio" in server_header or "lmstudio" in powered_by:
                    ...
                    detected = "vllm"
                elif "openai" in str(resp.headers) or urlparse(base_url).hostname == "api.openai.com":
                    detected = "openai"
                elif "anthropic" in str(resp.headers) or (urlparse(base_url).hostname or "").endswith("anthropic.com"):
                    detected = "anthropic"
